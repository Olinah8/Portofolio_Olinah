            ...
            <div className="row">
              ...
              <div className="col-sm-6">
                <div className="card info">
                  ...
                  >
                    Agée de 24 ans,<br></br>
                    Je suis une développeuse web,<br></br>
                    Avoir la connaissance de conception et de design <br></br>{" "}
                    UX
                  </p>
                  <br></br>
                  <div className="card progres text-sm">
                    ...
                    <div
                      className="col-sm-5 progress bar"
                      style={{ height: "8px", width: "45%" }}
                    >
            ...
            <div>
              ...
              <div className="card compet">
                <p className="text-center">
                  J'UTILISE MA PASSION ET MES COMPÉTENCES<br></br>
                  POUR CRÉER DES PRODUITS NUMÉRIQUES ET EXPÉRIENCES NATIONALE.
                  LES CLIENTS <br></br> COMPTENT SUR MOI POUR L'ANALYSE, LA
                  CONCEPTION ET LE DEVELOPPEMENT DES <br></br>SITES WEB OU DES
                  APPLICATIONS.
                </p>
                <br></br>
                <p className="text-center">
                  JE SUIS UNE FEMME RESPONSABLE ET RIGOUREUSE QUI S'ADAPTENT A
                  TOUT POUR <br></br>PROGRESSER MES CONNAISSANCES CAR POUR MOI
                  TOUT S'APPREND.
                </p>
              </div>
            </div>
                ...
                <div className="card exp">
                  <div className="row">
                    <div className="col-sm-9">
                      <b className="text-sm">
                        Stage de l'entreprise au sein de HAISOA SARLU à
                        Antananarivo
                      </b>
                      <p>
                        Pendant la stage j'ai accompli la conception et la
                        réalisation d'une application MIHARO qui a une objectif
                        de communiquer les acteurs et de mettre en ligne les
                        produits agricoles et les matériaux agricoles en
                        utilisant react js et node js
                      </p>
                    </div>
                  ...
                  <div className="row">
                    <div className="col-sm-9">
                      <b className="text-sm">
                        Stage au sein de VIVA évènement à Toamasina
                      </b>
                      <p>
                        Conception et réalisation d'un site web pour publier les
                        nouveaux et de mettre en direct l'évènement de VIVA en
                        utilisant PHP
                      </p>
                    </div>
                    <div className="col-sm-3">
                  ...
                  <div className="row">
                    <div className="col-sm-9">
                      <b className="text-sm">
                        Stage au sein de la DRENETP Atsimo andrefana{" "}
                      </b>
                      <p>
                        Conception et réalisation d’une application web pour la
                        gestion des notes de CEPE en utilisant PHP
                      </p>
                    </div>
                    <div className="col-sm-3">
                  ...
                  <div className="row">
                    <div className="col-sm-9">
                      <b className="text-sm">
                        Master professionnel en Informatique Générale
                      </b>
                    </div>
                    <div className="col-sm-3">
                      <b className="text-sm">2023</b>
                  ...
                  <div className="row">
                    <div className="col-sm-9">
                      <b className="text-sm">
                        Licence professionnelle en Informatique Générale
                      </b>
                    </div>
                    <div className="col-sm-3">
                      <b className="text-sm">2021</b>
                ...
                <form ref={form} onSubmit={sendEmail}>
                  <div className="relative border-b-2">
                    <input
                      ...
                      id="nom"
                      placeholder=" "
                      className="block w-full appearance-none focus:outline-none bg-transparent text-sm"
                    />
                    <label
                      htmlFor="nom"
                      className="absolute top-0 -z-1 duration-300 origin-0 text-sm "
                    >
                      Votre nom
                    </label>
                  </div>
                  ...
                  <div className="relative border-b-2 focus-within:border-blue-500">
                    ...
                    <label
                      htmlFor="message"
                      className="absolute top-2 -z-1 duration-300 origin-0 text-sm "
                    >
                      Votre message
                    </label>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center">
                    <button
                      type="submit"
                      className="text-gray-900 bg-dark border border-gray-300 focus:outline-none hover:bg-gray-100 
            ...
            <div className="reseau">
              <table>
                <tbody>
                  <tr>
                    <td>
                      <a href="https://web.facebook.com/profile.php?id=100006938772608">
                        {" "}
                        <FaFacebook className="fbs" />{" "}
                      </a>
                    </td>
                    <td>
                      <a href="https://www.instagram.com/olynah3">
                        {" "}
